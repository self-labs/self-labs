...
export const ui = {
  pt: {
    ...
    prova: {
       ...
       */
      nota: (data: string) =>
        `Contados pela API do GitHub em ${data}, não estimados. Atualizam sozinhos toda segunda.`,
      itens: {
        commits: {
          unidade: "commits",
        ...
        prs: {
          unidade: "PRs aceitos",
          legenda: "em projetos de outras pessoas",
        },
        producao: {
          unidade: "em produção",
          legenda: "sistemas no ar em selflabs.org",
        },
        meses: {
          unidade: "meses",
          legenda: "de operação contínua e rastreável",
        },
      },
    },
    ...
    producao: {
      ...
      etapas: [
        {
          rotulo: "push",
          texto: "Commit na master do GitHub ou do Forgejo próprio.",
        },
        {
          rotulo: "CI",
          texto:
            "Testes, typecheck e build da imagem em runner nativo da arquitetura alvo.",
        },
        {
          rotulo: "registry",
          texto: "Imagem publicada com tag CalVer no padrão ano.mês.revisão.",
        },
        {
          rotulo: "webhook",
          texto: "O stack do Portainer recebe o gatilho e puxa a versão nova.",
        },
        {
          rotulo: "no ar",
          texto:
            "Cloudflare Tunnel conecta de saída. Nenhuma porta aberta no host.",
        },
      ],
    ...
    contato: {
      ...
      links: [
        ...
        {
          rotulo: "Organização Self-Labs",
          href: "https://github.com/self-labs",
        },
        {
          rotulo: "Loja de hardware wallet",
          href: "https://store.selflabs.org",
        },
      ],
    },
    ...
    rodape: {
      ...
      construido:
        "Página estática em Astro, servida pelo Cloudflare Workers no apex, publicada por webhook.",
      versaoLabel: "versão",
  ...
  en: {
    ...
    prova: {
      ...
      itens: {
        ...
        producao: {
          unidade: "in production",
          legenda: "systems live on selflabs.org",
        },
        meses: {
          unidade: "months",
          legenda: "of continuous, traceable operation",
        },
      },
    },
    ...
    producao: {
      ...
      etapas: [
        {
          rotulo: "push",
          texto: "Commit to master on GitHub or on my own Forgejo.",
        },
        {
          rotulo: "CI",
          texto:
    ...
    contato: {
      ...
      canais: {
        ...
        whatsappLabel:
          "Open a WhatsApp conversation with a message already written",
      },
      links: [
        { rotulo: "Personal GitHub", href: "https://github.com/CaTeIM" },
        {
          rotulo: "Self-Labs organisation",
          href: "https://github.com/self-labs",
        },
    ...
    rodape: {
      ...
      construido:
        "Static Astro page served by Cloudflare Workers on the apex, published by webhook.",
      versaoLabel: "version",
